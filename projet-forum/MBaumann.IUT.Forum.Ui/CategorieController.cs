...
namespace MBaumann.IUT.Forum.Ui
{
    public class CategorieController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Nom,Description,Cle,Ordre,Creation,Modification")] Categorie categorie)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(short id, [Bind("Id,Nom,Description,Cle,Ordre,Creation,Modification")] Categorie categorie)
        {
            if (id != categorie.Id)
            {
                return NotFound();
